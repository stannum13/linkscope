...
COMPACT_FORMAT = "linkscope.compact.v1"
LEGACY_COMPACT_FORMAT = "photon-link-lab.compact.v1"
...
def load_compact_model(path: str | Path) -> tuple[LinkConfig, ModulatorConfig]:
    ...
    if payload.get("format") not in {COMPACT_FORMAT, LEGACY_COMPACT_FORMAT}:
...
def compact_model_to_verilog_a(
    ...
    lines = [
        "// LinkScope behavioral compact model",
